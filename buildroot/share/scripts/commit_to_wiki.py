...
# Check if the file "What's-New-in-this-Release.md" is present
if "What's-New-in-this-Release.md" in wiki_contents:
    print("File 'What's-New-in-this-Release.md' found in the directory.")
else:
    print("File 'What's-New-in-this-Release.md' not found in the directory.")
...
# Check if the file "What's-New-in-this-Release.md" is present in the GITHUB_WORKSPACE directory
if "What's-New-in-this-Release.md" in workspace_contents:
    print("File 'What's-New-in-this-Release.md' found in the GITHUB_WORKSPACE directory.")
else:
    print("File 'What's-New-in-this-Release.md' not found in the GITHUB_WORKSPACE directory.")
...
# Search for the file "What's-New-in-this-Release.md" within the GITHUB_WORKSPACE directory
file_path = find_file(workspace_path, "What's-New-in-this-Release.md")

if file_path:
    print(f"File 'What's-New-in-this-Release.md' found at: {file_path}")
else:
    print("File 'What's-New-in-this-Release.md' not found in the GITHUB_WORKSPACE directory.")
